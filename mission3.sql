...
--
-- Hôte : localhost:3306
-- Généré le : ven. 05 avr. 2024 à 12:47
...
(5, '2023_12_15_101858_create_ferries_table', 1),
(6, '2023_12_15_113934_create_equipements_table', 1),
(7, '2023_12_15_114043_create_equipement_ferry_table', 1);
...
(2, 'anatole', 'a.d@gmail.com', NULL, '$2y$12$v8.DqAd1V4f.GOchtH8XI.bfR0FkCi8/jn5sSUp/xIhsUomh8Xj6O', 'eiRoAJMv7GnVU9ipgSFYH5xjdclN3iCVKVYSnNKiOoN25U851N9mr1M410Sv', '2024-03-07 11:39:10', '2024-03-07 11:39:10'),
(3, 'a', 'du@gmail.com', NULL, '$2y$12$lLdM2nH6FdGXNh9ZGfrf9enL0W5xR5ZrxSprLHQDGazlO1cyu1q2i', NULL, '2024-03-08 09:08:01', '2024-03-08 09:08:01'),
(4, 'd', 'a@gmail.com', NULL, '$2y$12$YQh9bXEC3Y7gkb9i2yJqzuI5BXu0BQHi4pSQGG6pCFO/eF83yaAWi', NULL, '2024-03-15 06:10:59', '2024-03-15 06:10:59');
...
--
ALTER TABLE `equipement_ferry`
  ADD CONSTRAINT `equipement_ferry_equipement_id_foreign` FOREIGN KEY (`equipement_id`) REFERENCES `equipements` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `equipement_ferry_ferry_id_foreign` FOREIGN KEY (`ferry_id`) REFERENCES `ferries` (`id`) ON DELETE CASCADE;
COMMIT;
